...
# Absolute imports for modules loaded via sys.path
...
class ScraperAgent:
    """An agentic web scraper operating based on external JSON configs."""
    ...
    def scrape_page(self):
        ...
        try:
            ...
            logging.info(f"Found {len(item_elements)} items on this page.")
